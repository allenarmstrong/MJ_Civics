...
$(jgallery_container).each(function() {
$.ajax({
		url: $(this).attr('rel'),
		dataType: 'xml',
...
/*         console.log(audioSrc, audio); */
        ...
        soundManager.onready(function() {
          if (audioSrc !== '') {
			...
			// SHOW INSTRUCTIONS
			showOverlay("Instructions", directions, "Continue", jgallery_container);
			...
			for (i = 0; i < photo.length; i++) {
				...
				if (audio[i] === 'true') {
				  $(jgallery_container + ' .text').eq(i).after('<div class="audio-controls"><div class="title">Audio</div><div class="play"><a><img src="../../imgs/jQuery/icons/btn-play.png" alt="Play" /></a></div> <div class="pause"><a><img src="../../imgs/jQuery/icons/btn-pause.png" alt="Pause" /></a></div><div class="mute"><a><img src="../../imgs/jQuery/icons/btn-mute.png" alt="Mute" /></a></div><div class="unmute"><a><img src="../../imgs/jQuery/icons/btn-unmute.png" alt="UnMute" /></a></div></div>');
				}
			};
			
			//ADD Navigation, Prev and Next Items
			$(jgallery_container).append('<div class="navigation">'+jgallery_navNum+' of '+total+'</div><div id="jprev"><div>PREV</div></div><div id="jnext"><div>NEXT</div></div>');
