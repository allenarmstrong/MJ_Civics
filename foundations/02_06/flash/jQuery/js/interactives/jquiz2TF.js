$(document).ready(function() {
  ...
  function init(directions, endfeedback, statements, correct, incorrect, selections, answers, audio) {
  
    tries_num = 0;
    correct_num = 0;

  	// SHOW INSTRUCTIONS
  	showOverlay("Instructions", directions, "Continue");
